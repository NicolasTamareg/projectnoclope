        ...
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              ...
              <a class="text-gray-300 hover:text-white px-3 py-2 rounded-md text-lg font-bold font-large"><RouterLink  to="/">NO CLOPE</RouterLink></a>
              <a href="#" class="bg-gray-900 text-white px-3 py-2 rounded-md text-sm font-medium" aria-current="page"><RouterLink to="/">Accueil</RouterLink></a>
